...
log_filename = '/var/bongacams/models_data.log'
...
def scrape_model_data(model_name):
    ...
    try:
        ...
        conn.commit()
        logging.info(f"Модель {model_name} была успешно обновлена в базе данных.")
    except requests.RequestException as e:
...
def scrape_all_models():
    ...
    try:
        ...
        logging.info("Парсинг и обновление данных о моделях завершены.")
    except sqlite3.Error as e:
